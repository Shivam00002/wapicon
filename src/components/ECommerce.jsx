      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row items-start">
          <div className="w-full lg:w-1/2 pr-0 lg:pr-12">
            ...
            >
              <motion.p className="text-base sm:text-lg text-gray-600 dark:text-gray-300 mb-4 leading-relaxed">
                Wapikon's{" "}
          ...
          <div className="w-full lg:w-1/2 mt-10 lg:mt-8 flex items-center justify-center">
            <motion.div
              style={{
                y: imageY,
                scale: imageScale,
