      ...
      <div className="max-w-7xl mx-auto">
        <div className="flex flex-col lg:flex-row">
          <div className="w-full lg:w-1/2 pr-0 lg:pr-8">
            <div className="inline-flex items-center bg-gray-100 dark:bg-gray-800 px-4 py-2 rounded-full mb-6">
          ...
          <div className="w-full lg:w-1/2 mt-10 lg:mt-0 flex items-center justify-center lg:justify-end relative">
            <motion.div
