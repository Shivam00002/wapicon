      ...
      <div className="max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {plans.map((plan, index) => (
            ...
            >
              {plan.popular && (
                <div className="absolute top-0 right-0 bg-green-500 text-white py-1 px-3 sm:px-4 rounded-bl-lg text-xs sm:text-sm font-medium">
                  Most Popular
                </div>
              )}
              ...
              <div className="p-4 sm:p-6">
                ...
                <div className="bg-red-100 dark:bg-red-900/20 rounded-full py-1 sm:py-2 px-3 sm:px-4 text-red-600 dark:text-red-300 text-xs sm:text-sm mb-4">
                  {plan.promotion}
                </div>
                ...
                <button className="w-full py-2 sm:py-3 px-4 bg-white dark:bg-gray-800 text-green-500 border border-green-500 rounded-md font-semibold text-sm sm:text-base hover:bg-green-50 dark:hover:bg-green-900/20 transition-colors mb-4 sm:mb-6">
                  Signup Now
                </button>

                <div className="max-h-60 sm:max-h-80 overflow-y-auto pr-2 space-y-2 sm:space-y-3 scrollbar-thin scrollbar-thumb-gray-300 scrollbar-track-gray-100 dark:scrollbar-thumb-gray-700 dark:scrollbar-track-gray-800">
                  {plan.features.map((feature, featureIndex) => {
                    const isObject = typeof feature === "object";
                    const featureText = isObject ? feature.feature : feature;
                    const isAvailable = isObject
                    ...
                    return (
                      ...
                      >
                        {isAvailable ? (
                          ...
                          <X
                            size={18}
                            className="text-gray-400 dark:text-gray-500 mt-0.5 mr-2 flex-shrink-0"
                          />
                        )}
                        <span
                          className={`${
