...
const EcommerceFeatures = () => {
  ...
  return (
    <div className="w-full mt-5 bg-white dark:bg-gray-900 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-7xl mx-auto">
        <motion.div
          ...
          variants={fadeIn}
        >
          <h2 className="md:text-4xl sm:text-5xl font-bold text-gray-900 dark:text-white mb-4">
        ...
        >
          {features.map((feature) => (
            ...
            >
              <div className="p-6">
                <div className="mb-5">
                  <div className="bg-green-50 dark:bg-green-900/20 p-3 rounded-lg inline-block">
                    {feature.icon}
                  </div>
                </div>
